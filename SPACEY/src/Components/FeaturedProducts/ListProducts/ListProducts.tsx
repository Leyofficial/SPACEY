...
const ListProducts = ({
  ...
  return (
    <nav className={style.container}>
      <ul>
        <li
          onClick={() => callback("All Product")}
          className={`${style.startLink} ${
            activeItem === "All Product" ? style.activeItem : ""
          }`}
        >
          All Product
        </li>
        ...
        {filteredData.map((category, index: number) => (
          <li
            ...
            className={activeItem === category ? style.activeItem : ""}
            key={index}
          >
            {category}
          </li>
        ...
        <li
          onClick={() => callback("Browse All Product")}
          className={`${style.endLink} ${
            activeItem === "Browse All Product" ? style.activeItem : ""
          }`}
        >
          Browse All Product <BsArrowRightShort></BsArrowRightShort>
        </li>
      </ul>
    </nav>
  );
