    ...
    <>
      ...
      <div className={style.block}>
        <NavLink className={style.link} to={`/product/${item._id}`}>
          ...
          {image ? (
            <img className={style.image} src={image ? image : ""} alt="" />
          ) : (
            <Skeleton
              className={style.imgSkeleton}
              variant={"rounded"}
              width={216}
              height={188}
            />
          ...
          <div className={style.iconsBlock}>
            <div className={style.wrapperBlock}>
              <CustomIconButton
                callback={handleAddToWist}
                shaped={true}
                icon={<MdFavoriteBorder size={30} color={"black"} />}
              />
              <CustomIconButton
                callback={handleAddToCart}
                shaped={true}
                icon={<PiBasket color={"black"} size={30} />}
              />
              <CustomIconButton
                callback={handleEyeClicked}
                shaped={true}
                icon={<AiOutlineEye size={30} color={"black"} />}
              />
            </div>
          </div>
        </NavLink>
