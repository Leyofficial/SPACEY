...
function SignUp({ callback }: ICallbackAccount) {
  ...
  useEffect(() => {
    ...
    axios
      .post("https://spacey-server-two.vercel.app/auth/google", {
      ...
      .then((res) => {
        successAction(
          res.data.createdAccount.googleToken,
          navigate,
          "/congratulations",
          callback
        );
  ...
  // https://spacey-server-two.vercel.app/auth
  const submit: SubmitHandler<MyForm> = (data) => {
    ...
    axios
      .post("https://spacey-server-two.vercel.app/auth", {
        givenName: data.name,
        email: data.email,
      ...
      .then((response) => {
        ...
        successAction(
          response.data.newUser.userToken,
          navigate,
          "/congratulations",
          callback
        );
