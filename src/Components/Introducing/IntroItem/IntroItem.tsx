  ...
  return (
    <div
      className={`${style.item} ${
        typeItem === "yellow" ? style.whiteBackground : ""
      }`}
    >
      <div className={style.info}>
        <p
          className={`${style.title} ${
            typeItem === "yellow" ? style.blue : ""
          }`}
        >
          {title}
        </p>
        <h3
          className={`${style.itemTitle} ${
            typeItem === "yellow" ? style.color : ""
          }`}
        >
          New {item?.product.title}
        </h3>
        <p
          className={`${style.description} ${
            typeItem === "yellow" ? style.innerColor : ""
          }`}
        >
      ...
      <div className={style.coverImage}>
        <CustomSkeleton image={image} height={240} width={240}>
          <img
